"""
File: imds.py
Description: contains revelant GCP Compute Instance Metadata functions and actions
"""
...
class GcpImds():
  ...
  def get_instance_access_token(self, instance_ip: str, key_file: str, user: str) -> None:
